...
const pizza_names: string[] = ['papproni', 'deep dish pizza', 'itliean']

const comments: string[] = ['i dont like', 'i just live', 'i hate the']

for (let index = 0; index < pizza_names.length; index++) {
    const pizza = pizza_names[index];
